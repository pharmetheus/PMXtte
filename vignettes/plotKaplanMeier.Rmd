...
```{r setup}
devtools::load_all("/PMX/Projects/Pharmetheus/PMXtte/PMXtte/")
...
To create a basic plot with a single you can use the default settings 
...
we can also change the colors by modifying the palette and theme. 
```{r,fig.width=10,fig.height=6,out.width="100%"}
plotKaplanMeier(RTTEdata,
                time_col = 'TSFDW', #The default value
                cov_col = "DOSE",
                palette = PMXColors::pmx_palettes(firstColorNum = 3),
